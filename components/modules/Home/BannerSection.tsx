      ...
      <div className="container grid grid-cols-1 lg:grid-cols-2 gap-10 items-center max-w-7xl w-full relative z-10">
        ...
        <div>
          ...
          <div className="flex gap-4 mb-4">
            ...
            <a
              href="https://drive.google.com/file/d/1zhg1eOiMhasGJbmx6P9wJKNHAnbjSKX9/view?usp=sharing"
              download="https://drive.google.com/file/d/1zhg1eOiMhasGJbmx6P9wJKNHAnbjSKX9/view?usp=sharing"
              target="_blank"
