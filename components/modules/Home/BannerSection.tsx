      ...
      <div className="container grid grid-cols-1 lg:grid-cols-2 gap-10 items-center max-w-7xl w-full relative z-10">
        ...
        <div>
          ...
          <p className="text-gray-300 mb-7 text-lg">
            A results-oriented Data Analyst with 4+ years of experience in
          ...
          <div className="flex gap-4 mb-4">
            ...
            <a
              href="https://drive.google.com/file/d/1PCYeAD5UYAZdpb2t86tIcLEXB6EstwGp/view?usp=sharing"
              download="https://drive.google.com/file/d/1PCYeAD5UYAZdpb2t86tIcLEXB6EstwGp/view?usp=sharing"
              target="_blank"
